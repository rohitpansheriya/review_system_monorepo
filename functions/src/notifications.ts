...
function ownerGracePeriodReminderHtml(
  ...
  return [
    ...
    "      <img src=\"https://appnexa.co.in/assets/images/appnexa-logo-white.png\" alt=\"AppNexa Technologies\" width=\"180\" style=\"display:block;margin:0 auto 8px auto;border:0;outline:none;height:auto;max-width:180px;\" />",
    "      <p style=\"color:#cbd5e1;margin:0;font-size:13px;font-weight:500;\">Google Review Growth &amp; Counter Standee System</p>",
    "    </div>",
    "    <!-- Alert Banner -->",
...
function ownerReminderHtml(brandName: string, daysDiff: number, paymentLinkUrl: string): string {
  ...
  return [
    ...
    "    <div style=\"background:linear-gradient(135deg, #1b3a8c, #2f6bff);padding:24px 28px;text-align:center;\">",
    "      <img src=\"https://appnexa.co.in/assets/images/appnexa-logo-white.png\" alt=\"AppNexa Technologies\" width=\"180\" style=\"display:block;margin:0 auto 8px auto;border:0;outline:none;height:auto;max-width:180px;\" />",
    "      <p style=\"color:#cbd5e1;margin:0;font-size:13px;font-weight:500;\">Subscription Renewal Notice</p>",
    "    </div>",
...
export async function sendOwnerWelcomeEmail(
  ...
  const html = [
    ...
    "          <!-- Gradient Header -->",
    "          <tr>",
    "            <td style=\"background: linear-gradient(135deg, #1B3A8C 0%, #2F6BFF 100%); padding: 32px 28px; text-align: center;\">",
    "              <img src=\"https://appnexa.co.in/assets/images/appnexa-logo-white.png\" alt=\"AppNexa Technologies\" width=\"190\" style=\"display: block; margin: 0 auto 10px auto; border: 0; outline: none; height: auto; max-width: 190px;\" />",
    "              <p style=\"margin: 0; color: #E0E7FF; font-size: 13px; font-weight: 500; letter-spacing: 0.2px;\">Smart NFC &amp; QR Review Management System</p>",
    "            </td>",
    "          </tr>",
    "          <!-- Main Content -->",
    "          <tr>",
...
export async function sendPaymentLinkEmail(
  ...
  const html = [
    ...
    "          <!-- Gradient Header -->",
    "          <tr>",
    "            <td style=\"background: linear-gradient(135deg, #1B3A8C 0%, #2F6BFF 100%); padding: 28px 24px; text-align: center;\">",
    "              <img src=\"https://appnexa.co.in/assets/images/appnexa-logo-white.png\" alt=\"AppNexa Technologies\" width=\"180\" style=\"display: block; margin: 0 auto 8px auto; border: 0; outline: none; height: auto; max-width: 180px;\" />",
    "              <p style=\"margin: 0; color: #E0E7FF; font-size: 13px; font-weight: 500;\">Complete Your Business Enrollment</p>",
    "            </td>",
    "          </tr>",
    "          <!-- Main Content -->",
    "          <tr>",
...
function getPasswordResetEmailHtml(email: string, resetLink: string): string {
  return [
    ...
    "            <td style=\"background: linear-gradient(135deg, #1B3A8C 0%, #2F6BFF 100%); padding: 28px 24px; text-align: center;\">",
    "              <img src=\"https://appnexa.co.in/assets/images/appnexa-logo-white.png\" alt=\"AppNexa Technologies\" width=\"180\" style=\"display: block; margin: 0 auto 8px auto; border: 0; outline: none; height: auto; max-width: 180px;\" />",
    "              <p style=\"margin: 0; color: #E0E7FF; font-size: 13px; font-weight: 500;\">Google Review Growth &amp; Counter Standee System</p>",
    "            </td>",
    "          </tr>",
    "          <!-- Alert Header Banner -->",
    "          <tr>",
